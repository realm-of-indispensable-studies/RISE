...
import OfflineWorkShops from "./pages/OfflineWorkShops";
import OnlineWorkShops from "./pages/OnlineWorkShops";
import NexusGBC from "./pages/NexusGBC";
    ...
    <TooltipProvider>
      ...
      <ScrollToTop />
        <Routes>
          ...
          <Route path="/offline-session" element={<OfflineWorkShops />} />
          <Route path="/online-session" element={<OnlineWorkShops />} />
          <Route path="/nexus-gbc" element={<NexusGBC />} />
